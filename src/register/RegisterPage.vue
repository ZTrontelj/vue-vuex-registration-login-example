<template>
    <div id="outer-register">
        ...
        <div id="title-register" class="text-primary">
            <h4>REGISTER</h4>
        </div>
        ...
        <form @submit.prevent="handleSubmit">
            ...
            <div class="form-group">
                <input type="text" v-model="user.username" v-validate="'required'" name="username" class="form-control" :class="{ 'is-invalid': submitted && errors.has('username') }" placeholder="Username"/>
            ...
            <div class="form-group">
                <button class="btn btn-outline-primary" :disabled="status.registering">Register</button>
